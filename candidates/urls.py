...
urlpatterns = [
    path('', views.candidate_details, name='detail-candidates'),
    path('job-search/', views.home, name='home'),
    ...
    path('relevant-jobs/', views.intelligent_search, name='intelligent-search'),
